...
\mathbb{P}(X=0) &= \mathbb{P}(X\in A)= \mathbb{P}(X\in A)\cdot 1 + \mathbb{P}(X\notin A)\cdot 0 =\mathbb{E}[\mathbb{1}_A \circ X] = \mathbb{E}\big[\mathbb{E}[\mathbb{1}_{A}\circ X|\pi]\big] \nonumber \\
