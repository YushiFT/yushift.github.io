...
### QCB508 / QCB408 / Foundations of Statistical Genomics
    ...
    Course ID: QCB 508 / QCB 408 / BST 282
...
More specifically, try to think about two questions: 1) what is the math definition of $\text{Cov}(X,Y)$; 2) how to introduce the conditional terms into the expanded version of $\text{Cov}(X,Y)$.
